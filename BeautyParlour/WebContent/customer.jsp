	...
	function getAllRecords(){
		$.ajax({
			...
			success:function(data){
				...
				table+="<thead>";
				table+="<tr><th>Name</th><th>Contact</th><th>Address</th><th>Inserted Date</th><th>Action</th></tr>";
				table+="</thead>";
		...
		<div class="row">
			<div class="col-md-4">
				<form action="/action_page.php">
					...
					<div class="form-group">
						<label for="cost">Contact:</label> <input type="text"
							class="form-control" id="contact" placeholder="" name="contact">
					</div>
					<div class="form-group">
						<label for="cost">Address:</label> <input type="text"
							class="form-control" id="address" placeholder="" name="address">
					</div>
